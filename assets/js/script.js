...
//add click event to certificate
document.addEventListener('DOMContentLoaded', function() {
  const clientsItems = document.querySelectorAll('.clients-item img');
...
function sendMail() {
  ...
  const mailtoLink = `mailto:abhishektyagi9875@gmail.com?subject=${subject}&body=${body}`;
